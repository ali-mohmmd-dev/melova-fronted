  ...
  useEffect(() => {
    async function fetchCustomerData() {
      ...
      try {
        ...
        const customersRes = await api.get("api/auth/customers/");
        const allCustomersArray = Array.isArray(customersRes.data) ? customersRes.data : customersRes.data.results || [];
        ...
        const ordersRes = await api.get("api/shop/orders/");
        const allOrdersArray = Array.isArray(ordersRes.data) ? ordersRes.data : ordersRes.data.results || [];
